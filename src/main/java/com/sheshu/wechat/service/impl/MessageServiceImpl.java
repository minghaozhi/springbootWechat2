...
public class MessageServiceImpl implements MessageService {
    ...
    public String responseMessage(Map<String, String> map) {
        ...
        news.setPicUrl("http://gaopinimages.com/imagesflow/133206336414");
        news.setUrl("http://mp.weixin.qq.com/mp/appmsg/show?__biz=MjM5NDM0NTEyMg==&appmsgid=10000046&itemidx=1&sign=9e7707d5615907d483df33ee449b378d#wechat_redirect");
        newsList.add(news);
...
//        String xml = MessageUtils.musicMessageToXml(musicMessage);
        ...
        if(Constants.MESSAGE_TYPE_EVENT.equals(msgType)){//推送消息事件
            ...
            if(Constants.EVENT_TYPE_CLICK.equals(event)){//点击事件
